...
# paramètres du tuyau
D_tuy = np.linspace(0.10,0.5,200)
...
for epaisseur_iso in t_iso:
    ...
    R_cond_iso = calculer_Rconduction_cylindre(D_iso, epaisseur_iso, L_tuy, k_iso)
    R_S = R_profond(L_tuy, Z_tuyau, D_iso + 2*epaisseur_iso, conductivite_sol)
...
plt.xlabel("Diamètre du tuyaux [m]", fontsize=18)
