...
# Code pour le graphique qui met en relation la profondeur du tuyau et les pertes estimées pour différentes épaisseurs d'isolsant
...
Z_tuyau = np.linspace(3*D_tuy/2, 3, 200) # plage de valeurs de la profondeur du tuyau dans le sol en m
...
for epaisseur_iso in t_iso:
    ...
    plt.plot(Z_tuyau, np.abs(pertes)/1000, label=f"Épaisseur de l'isolant = {epaisseur_iso*100:.0f} cm")
