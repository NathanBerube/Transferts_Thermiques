...
# Code permettant d'obtenir les caractéristiques importantes selon différents paramètres pour la solution dans le sol
...
R_S = R_profond(L_tuy, Z_tuyau, D_iso + 2*t_iso, conductivite_sol) # résistancde de conduction dans le sol
