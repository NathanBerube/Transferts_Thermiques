...
# Code pour le graphique qui met en relation l'épaisseur de l'isolant et les pertes estimées pour différents diamètres de tuyau
...
for diametre in D_tuy:
    ...
    t_iso = np.linspace(0,0.10,1000) # plage de valeurs pour l'épaisseur d'isolant en m pour construire le graphique
...
# étape 1: évaluer la température en entrée des bâtiments
    ...
    R_tot = R_conv_int + R_cond_tuy +  R_cond_iso + R_conv_ext
